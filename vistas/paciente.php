...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Informacion báscia de todos los pacientes que ingresaro9n al hospital</p>
                
                    <!--boton para agregar registro-->
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <button type="button" id="btnNuevo" class="btn btn-primary" data-toggle="modalPaciente">
                    ...
                    <div class="card shadow mb-8">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Consulta Pacientes</h6>
                        </div>
                        <div class="card-body">
 ...
 <div class="modal fade" id="modalPaciente" tabindex="-1" aria-labelledby="modalEmpleado" aria-hidden="true">
            ...
            <div class="row">     
				<div class="col-lg-6">
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" placeholder="154120" pattern="[0-9]+" title="Solo ingrese números" id="id" required>
                  </div> 
                </div>	
				<div class="col-lg-6">
                  <div class="form-group">
                      <label class="col-form-label">Nombre</label>
                      <input type="text" class="form-control" placeholder="Nombres" pattern="[A-Za-z ]+" title="Solo ingrese caracteres, nada de numeros" id="nom" required>
                  </div> 
                </div>			
				<div class="col-lg-6">
                  <div class="form-group">
                      <label class="col-form-label">Apellido</label>
                      <input type="text" class="form-control" placeholder="Apellidos" pattern="[A-Za-z ]+" title="Solo ingrese caracteres, nada de numeros" id="ape" required>
                  </div> 
                </div>							
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="col-form-label">Direccion</label>
                      <input type="text" class="form-control" placeholder="Carrera 13b Este No 41-15sur" pattern="[A-Za-z0-9#- ]+" id="dire" required>
                  </div> 
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="col-form-label" id="passwd1">Fecha de nacimiento</label>
                      <input type="date" class="form-control" placeholder="26/08/2021" id="fecha_nac" required>
                  </div> 
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
				...
				<div class="col-lg-6">
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" placeholder="3138587372" id="celu" required>
                  </div> 
                </div>
				<div class="col-lg-6">
					<div class="form-check">
					  <input class="form-check-input" type="radio" name="genero" id="genero" value="1" required>
					  <label class="form-check-label" for="flexRadioDefault1">
						Masculino
					  </label>					  
					</div>
					<div class="form-check" id="">
					  <input class="form-check-input" type="radio" name="genero" id="genero" value="2">
					  <label class="form-check-label" for="flexRadioDefault1">
						Femenino
					  </label>					  
					</div>
					<div class="form-check">
					  <input class="form-check-input" type="radio" name="genero" id="genero" value="3">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <label class="col-form-label">RH</label>
                      <select class="form-select" id="rh" aria-label="Default select example" requiered>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <label class="col-form-label">Estado</label>
                      <select class="form-select" id="estado" aria-label="Default select example" requiered>
                        <option selected>Seleccione una opción</option>
                        <option value="4">En valoracion</option>
