...
<head>
    ...
    <title>Empleados Hospital</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">En el siguiente apartado se muestran todos los empleados creados, agregar un nuevo empleado; o editarlos</p>
                
                    <!--boton para agregar registro-->
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <button type="button" id="btnAddEmpleado" class="btn btn-primary" data-toggle="modalEmpleado">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-user-nurse"></i>
                                        </span>
                                        <span class="text">Agregar Empleado</span>                                    
                                </button>
								<button type="button" id="btnAasignacion" class="btn btn-secondary" data-toggle="modalBusquedad">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-search"></i>
                                        </span>
                                        <span class="text">Asignacion</span>                                    
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-8">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Consulta Empleados</h6>
                        </div>
                        <div class="card-body">
 ...
 <div class="modal fade" id="modalEmpleado" tabindex="-1" aria-labelledby="modalEmpleado" aria-hidden="true">
  <div class="modal-dialog">
            ...
            <div class="row">     
				<div class="col-lg-6">
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" placeholder="154120" id="id" pattern="[0-9]+" title="Solo ingrese números" required>
                  </div> 
                </div>	
				<div class="col-lg-6">
                  <div class="form-group">
                      <label class="col-form-label">Nombre</label>
                      <input type="text" class="form-control" placeholder="Nombre" id="nom"  pattern="[A-Za-z ]+" title="Solo ingrese caracteres, nada de numeros" required>
                  </div> 
                </div>			
				<div class="col-lg-6">
                  <div class="form-group">
                      <label class="col-form-label">Apellido</label>
                      <input type="text" class="form-control" placeholder="Apellidos" id="ape" pattern="[A-Za-z ]+" title="Solo ingrese caracteres, nada de numeros" required>
                  </div> 
                </div>							
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="col-form-label">Direccion</label>
                      <input type="text" class="form-control" placeholder="Cll 13b 14-15"  pattern="[A-Za-z0-9#- ]+" id="dire" required>
                  </div> 
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="col-form-label" id="passwd1">Fecha de nacimiento</label>
                      <input type="date" class="form-control" placeholder="2003/09/30" id="fecha_nac"  max="2003-09-30" title="Solo se admited desde el 2003 porque el empleado debe ser mayor de edad" required>
                  </div> 
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <label class="col-form-label">Cargo</label>
                      <select class="form-select" id="cargo" aria-label="Default select example" required>
                  ...
                  <div class="form-group">
                    <label class="col-form-label">Estado</label>
                      <select class="form-select" id="estado" aria-label="Default select example" required>
						...
						<option value="9">Pensionado</option>
                      </select>
                  </div> 
                </div>
            </div>
    ...
    <!-- main del java scrip -->
	<script src="./js/data-empleados.js"></script>
    <!--Notificaciones-->
